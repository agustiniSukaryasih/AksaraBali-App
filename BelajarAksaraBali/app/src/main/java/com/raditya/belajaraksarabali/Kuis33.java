...
public class Kuis33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis33);
        ...
        button_next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent m2 = new Intent(Kuis33.this, Kuis34.class);
    ...
    private void playing(int arg){
        if (arg==1){
            mp= MediaPlayer.create(this, R.raw.bangkung);
            mp.start();
        }
    }
