...
public class Kuis42 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis42);
        ...
        button_next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent m2 = new Intent(Kuis42.this, Kuis43.class);
    ...
    private void playing(int arg){
        if (arg==1){
            mp= MediaPlayer.create(this, R.raw.sekolah);
            mp.start();
        }
    }
