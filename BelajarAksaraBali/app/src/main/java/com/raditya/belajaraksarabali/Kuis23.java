...
public class Kuis23 extends AppCompatActivity {

    Button jawab, button_next1;
    EditText text_jawab;
    int point, benar, salah;
    String jawabsoal = "krana";
    TextView salah_benar, nilai_point;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis23);
        ...
        button_next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent m2 = new Intent(Kuis23.this, Kuis24.class);
