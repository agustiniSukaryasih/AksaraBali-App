...
public class Kuis31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis31);
        ...
        button_next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent m2 = new Intent(Kuis31.this, Kuis32.class);
    ...
    private void playing(int arg){
        if (arg==1){
            mp= MediaPlayer.create(this, R.raw.arjuna);
            mp.start();
        }
    }
