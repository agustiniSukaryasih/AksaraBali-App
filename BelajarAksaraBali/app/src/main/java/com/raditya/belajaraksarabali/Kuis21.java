...
public class Kuis21 extends AppCompatActivity {

    Button jawab, button_next1;
    EditText text_jawab;
    int point = 0, benar = 0, salah = 0;
    String jawabsoal = "gora";
    TextView salah_benar, nilai_point;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kuis21);
        ...
        button_next1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent m2 = new Intent(Kuis21.this, Kuis22.class);
